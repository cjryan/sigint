self.port.on("send_link_pile", function sortLinks(link_pile) {
  ...
  $('.link_ref').click(function() {
    //maybe use $this.child to target only the below div?
