...
Similarly, many times one finds themselves using tabs as a research to-do list. This add-on aims to help you keep track of your purposeful research, so that you don't have to leave dozens of tabs open.
